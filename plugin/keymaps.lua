...
-- Notes
vim.keymap.set('n', '<leader>nn', ':e ~/notes/<CR>', { desc = 'Open notes directory' })
vim.keymap.set('n', '<leader>nd', ':e ~/notes/daily/' .. os.date '%Y-%m-%d' .. '.md<CR>', { desc = 'Create/open daily note' })
